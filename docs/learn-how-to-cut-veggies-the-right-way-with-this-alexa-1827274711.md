...
本质上，要让它工作，你只需要打开技能，然后问它如何切割东西。如果那个东西在它的库中，那么一个简短的视频将会播放给你看如何剁碎那个东西(或者如果你使用的是纯音频设备，就只有音频解释这个过程)。

每周都有新的东西被添加到应用程序中，开发者通过这个网站 接受关于这些新东西是什么 [的建议。](https://flavorfriday.com/) 

这是一种自由而简单的方法，在你切碎那东西之前检查自己，然后意识到你做错了，不小心毁了你的晚餐。