...
### 如何让 Face ID 重新扫描(以及为什么这很重要)

这个问题归根结底是 iPhone X 上的通知工作方式。在新的智能手机上，苹果改变了默认的锁屏设置，隐藏了所有重要的信息。你会看到信息来自谁和哪里，但在解锁设备之前，你无法真正阅读其内容。这对保护你的隐私很好，但在这种特殊情况下很烦人。

如果你的 iPhone X 放在你面前的桌子上，收到通知，你会很自然地看着手机。但是如果 Face ID 第一次尝试不成功，就没有明显的办法再试一次。你不能把头扭过去，回头看那个设备。你必须要么拿起设备，要么在返回锁定屏幕之前通过向上滑动导航到另一个屏幕——如果你每天都要做几十次，这两者都非常耗时。

谢天谢地，解决方案非常简单。在 Twitter 的一点帮助下，The Verge 发现你可以通过从锁定屏幕开始向上滑动来重新触发 Face ID，但不是一直向上。一旦你把杆向上拉了大约四分之一英寸，把它拉回到开始的位置。这将促使 Face ID 再次尝试，这一次你会看着设备的权利，所以(希望)它会工作