...
使用 Skyline 很容易。该应用程序可以通过 GPS 计算出你的确切位置，或者你可以搜索一个特定的地点。然后，在你确认新墙纸之前，它可以让你放大或缩小以找到完美的框架。从 Skyline 的设置中，你可以打开那些深度效果。如果你运行的是 Android 8.1 或更高版本，手机上的菜单也会改变颜色，以匹配你选择的地形。

如果这还不足以让你相信花两块钱买一个应用程序是值得的，开发者表示，他还在开发一个新功能，可以自动改变壁纸，以匹配你的当前位置以及其他一些新功能。但是，即使没有这些额外的东西，Skyline 也是一种非常酷的美化 Android 主屏幕的方式。