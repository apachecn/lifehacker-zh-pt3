...
更令人印象深刻(也更具侵入性)的是，Chatwatch 可以结合你的两个联系人的 WhatsApp 数据，做出一个有根据的猜测，看他们是否互相交谈过。基本上，如果你的两个朋友在凌晨同时在线连续五分钟，他们很有可能在互相发信息。

这是一个令人毛骨悚然的新技巧，该应用的开发者希望能让更多人关注脸书如何处理我们的数据，以及其他公司如何访问和分析这些数据。WhatsApp 也很有可能很快就会找到屏蔽 Chatwatch 的方法。所以，如果你想监视你的朋友，揭露脸书的隐私问题，你应该尽快尝试。

有一个小问题:Chatwatch 不是免费的——它实际上有点贵。花 1.99 美元，你就可以监视你的两个联系人一周，所以要谨慎选择。开发者表示，这笔钱将用于维护该应用，并资助一个反特朗普的政治非营利组织[。](https://www.fighttrump.today/)

Chatwatch 最初在 iOS 上推出，但后来被苹果从 App Store 下架，原因不明。目前 [可用于安卓](https://play.google.com/store/apps/details?id=net.dpo.ChatW&hl=en) ，开发者目前也在开发基于网络的版本。

***更新于 3 月 29 日，美国东部时间下午 3:41:更新了 Chatwatch 从 App Store 移除后的可用信息。*T3】**