...
### **power cube 的设计意味着再也不会用充电砖堵塞插座**

一些制造商根本不尊重其他可能需要使用你的插线板的设备。如果你的设备有一个巨大的电源块连接到插头端，你最终会阻塞你可能需要在常规电源板上使用的其他插座，特别是如果在最后的插座上已经有另一个巨大的块。PowerCube 的设计消除了这个问题。

由于 PowerCube 上的五个插座都在各自的表面上，当你插入巨型块时，没有重叠。没有任何东西会妨碍其他东西。事实上，如果你插上一个大块的东西，你可以把那一边放在地板上。正如我们前面提到的，如果将立方体放在地板上会损坏电缆，这可能是一个问题，但如果底部有一个块，您就有一个安全的表面来放置立方体。

* * *

PowerCube 并不适合每一种情况，但我惊讶地发现它非常适合我的一些设置。在我的娱乐单元上，它很容易让我插入许多向四面八方延伸的笨拙电缆。它非常适合让客人在沙发上给手机充电，也是给我的桌子增加几个额外插座的便捷方式。