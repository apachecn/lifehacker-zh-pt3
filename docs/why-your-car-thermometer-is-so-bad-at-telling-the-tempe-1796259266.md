...
真正的原因是热敏电阻的位置。大多数热敏电阻位于汽车前部的格栅后面(通常在两个前灯之间)。

这使得读数不太准确，尤其是在炎热、阳光充足的日子，因为它也会吸收道路辐射的热量。当你高速行驶时，或者当太阳没有照射到路面时，比如晚上和多云天气，测量是最准确的。

在寒冷的天气里，你的汽车热敏电阻仍然有助于测量零下或零上的温度，但是需要注意的是，它不是那么精确。你仍然可以使用它来查看不同地区的温度变化，但我们建议同时使用这款好天气应用。