...
只有在 App Store 批准了一个应用程序后，才能进行预购，客户在下载应用程序之前不会被收费。因此，这可能不会导致 vaporware 或 scammy 预售。这可能是更大的应用程序制造商主导搜索广告的另一种方式，使用小型竞争对手负担不起的三个月预购活动。或者，这可能是小创作者提前建立口碑的一种方式，并在第一天就登上排行榜榜首。

预购对于任何在 App Store 的“今日”标签中推广的应用程序都很有用，比如 [统治:女王陛下](https://www.devolverdigital.com/games/view/reigns-her-majesty) ，这是一款关于女王的机智而艺术的手机游戏。苹果在游戏发布前几天发表了热情洋溢的文章，我敢肯定它的创造者希望苹果能提供预购链接。

当然，我们不能在这里链接到这些文章，因为苹果只允许你在应用商店内阅读它们，这一举动对消费者和应用程序制造商来说是敌对的。经典苹果。

[苹果在 App Store](https://arstechnica.com/gadgets/2017/12/customers-now-preorder-apps-in-any-apple-app-store/) | Ars Technica 开启应用预购