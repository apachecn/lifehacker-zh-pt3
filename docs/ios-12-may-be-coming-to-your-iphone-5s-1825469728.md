...
iOS 12 对于 iPhone 5S 用户来说可能是一个特别有用的更新，因为据报道，苹果公司正在关注此次更新的漏洞修复和性能改进。不要期待奇迹，但 iOS 12 可以帮助你的旧智能手机获得一些新的生命。此次更新还可能增加更好的家长控制，如果你的孩子使用的是一部 [二手](https://lifehacker.com/the-etiquette-of-hand-me-down-electronics-5860606) iPhone 5S，这是一个好消息——你甚至可以从你崭新的 iPhone X 上与他们进行 FaceTime(当然是用动画表情符号)