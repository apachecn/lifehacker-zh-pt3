...
**如果你想用最少的努力获得最大的免费存储空间，Google Drive 是不二之选。但如果你需要超过 15GB 的空间，并且愿意为此付费，Google Drive 和 Dropbox 都提供了相当不错的价格。与 Google Drive 的 2 100GB 计划相比，OneDrive 的 2 50GB 选项似乎有点贵，但如果你沉迷于微软 Office 套件或 Windows，它可能值得这个价格。**
