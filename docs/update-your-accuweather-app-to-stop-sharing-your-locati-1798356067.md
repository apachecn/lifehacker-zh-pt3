...
当你更新你的 iOS 应用程序时，你应该花时间查看你手机中的位置设置，以确保你没有与你不希望访问所述信息的应用程序共享你的位置。

在您的 iOS 设备中，进入设置>隐私>定位服务。在那里，你可以挑选哪些应用程序可以访问你的位置数据，还可以看到每个应用程序对它们可能需要位置数据访问的解释，或者永久禁止它们，只允许它们在你使用应用程序时访问，或者总是允许它们访问位置数据(例如，非常适合你最喜欢的地图应用程序)。