...
我幼稚吗？一点点。但是这个字体提醒我，我们面对的不是一个正常的成年人，我们也不应该假装我们是。

想要一个更严肃的策略来打通总统的个人新闻频道吗？试试关注 [@RealPressSecBot](https://twitter.com/RealPressSecBot) ，它会给你所有川普的推文格式化为白宫官方声明。这个*也*并没有让它们更容易被接受，但是这种格式和青少年内容的并置提醒着我们:这是不正常的。