...
如果你想进一步了解你正在查看的位置，你可以点击窗口右下角的小地球图标，直接进入谷歌地球中的图片位置。如果你觉得自己更像印第安纳·琼斯，而不是在某一天完成工作，你也可以点击任何新标签底部的难以看到的箭头，调出新的谷歌地球图片来查看(以及新的游览地点)。

有太多的扩展可以用来给你的浏览器添加背景图片和主题。谷歌地球上的地球视图既漂亮又有教育意义，这是一个很好的方式给你一整天带来一点点快乐。快乐和旅游癖。
