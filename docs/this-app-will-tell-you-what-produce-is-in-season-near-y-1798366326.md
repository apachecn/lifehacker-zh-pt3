...
使用该网站，您可以选择您所在的州，然后查看某个时间段(例如“八月下旬”)的时令，或者您可以选择一种农产品，并了解您最喜欢的水果或蔬菜在哪个月份上市。还有一个“学习和烹饪”功能，为您提供关于您选择的植物部分的各种信息，包括简史、环境影响和食谱。该应用程序具有相同的功能，但也可以让你设置提醒，这样你就不会错过你最喜欢的浆果、胡椒或块根蔬菜。

[时令美食指南](https://www.seasonalfoodguide.org/california/late-august)