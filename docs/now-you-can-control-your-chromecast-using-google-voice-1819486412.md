...
除了工作只是播放一些东西，该功能还可以控制播放。所以你也可以让谷歌助手跳过一首歌，调高音量，或者暂停几分钟。

所有这些之前都可以在 Google Home 上使用，但这是第一次可以在你的手机或平板电脑上使用 Google Voice Assistant。

Android Police 注意到该功能正在逐步推出。所以，如果你还没有，过几天再试试。