...
几乎所有在你的 iOS 设备上购买的东西，无论是应用程序、音乐还是订阅服务，都将从你的 PayPal 账户中扣除。不幸的是，根据 PayPal 发言人的说法，由于苹果处理 Apple Pay 购买，你不能使用你的 PayPal 账户进行基于 NFC 的交易。

虽然你的 PayPal 账户可能会显示你的 Venmo 余额，但你无法使用点对点支付服务中的资金来资助你的应用程序习惯。目前，虽然一些接受 PayPal 的企业可以接受客户的 Venmo 余额付款，但在 iOS 上购物时，该功能目前不可用。希望 PayPal 最终会改变主意。