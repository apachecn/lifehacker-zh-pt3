...
Haptic Touchbar 是一个可下载的菜单栏应用程序，它为您的 Touchbar 添加了触觉反馈支持(当您点击触摸屏上的按键或点时，会产生快速振动的感觉)。当您按下 Escape 或功能键时，Haptic Touchbar 会激活 MacBook Pro 中的 Force Touch 触控板磁铁，从而振动您的笔记本电脑。您可以选择四个级别的反馈强度，以获得更安静(或更有力)的响应。

Haptic Touch Bar 售价 4.99 美元，但你可以使用 14 天的免费试用期来决定该功能是否值得你花掉林肯。作为一个触觉反馈( [我还是想要一个 Novint Falcon](https://gizmodo.com/novint-falcon-force-feedback-controller-gets-valve-supp-5019634) )的粉丝，任何指示你是否真的按下了触摸屏上的按钮的工具都是我可以得到的实用工具。