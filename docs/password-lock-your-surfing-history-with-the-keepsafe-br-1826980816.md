...
Keepsafe 最好的功能之一是它可以让你在浏览器上输入一个特殊的进入密码。换句话说，即使有人可以访问你的手机，并看到你输入登录密码，他们也无法访问你的浏览记录，除非你给他们你唯一的四位数密码，或者除非他们能以某种方式让你在手机的指纹扫描仪上按下手指。光是这个功能， [就能拯救无数的关系](https://www.youtube.com/watch?v=7cbFkmaJ0Us) 。

与其他浏览器一样，如果你想在设备上不留痕迹地浏览网站，Keepsafe 也提供了一个匿名选项——如果你需要确保没有人能看到你在做什么，这也是一个不错的选择(当然是在浏览器的 PIN 锁之外)。关闭浏览器，你在匿名标签上做的任何事情都将永远消失。