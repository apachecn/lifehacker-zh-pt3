...
要重新格式化 tweetstorm，将第一条推文的 URL 粘贴到 Thread Reader 中，或者用单词*展开*并提及 [@tttthreads](https://twitter.com/tttthreads) 来回复推文。

因为 Twitter 限制第三方工具的访问，线程阅读器只能检索相对较新的线程。如果用户自从他们的推特风暴以来已经发了 3200 次推特，它就不起作用了。以至于 [漫无边际的博弈论主线](https://twitter.com/ericgarland/status/808045818024497157) 都行不通。很好。