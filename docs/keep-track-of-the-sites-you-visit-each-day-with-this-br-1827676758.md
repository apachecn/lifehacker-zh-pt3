...
安装完扩展后，不要忘记点击浏览器地址栏旁边的图标，然后使用您的 Microsoft 帐户登录。否则，您的网站将不会被发送到 Windows 时间线。你还会错过该扩展的其他有趣功能，比如将任何打开的网页发送到你的另一台 Windows 电脑上。

该扩展甚至直接链接到你的微软账户的微软 [活动历史仪表盘](https://account.microsoft.com/privacy/activity-history) ，所以你可以看到微软的一些数据跟踪。当然，如果你决定不再让这个扩展访问你的账户，你可以在这里禁用它的权限。

* * *

你有自己非常喜欢的 Chrome 或 Firefox 扩展吗？请在评论中告诉我们。