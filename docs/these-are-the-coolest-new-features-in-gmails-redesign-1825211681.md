...
除了新的侧边栏，浏览器版的 Gmail 还借鉴了手机版的一些技巧。当更新到来时，你可以暂停桌面上的电子邮件，直到设定的时间将它们从收件箱中删除，如果你的收件箱像我一样一团糟，并且你担心重要的邮件会在混乱中丢失，这真的很有用。谷歌的更新还增加了智能回复——这些人工智能生成的一键回复很酷，但并不总是可用。

尚不清楚更新将于何时发布，但应该会很快发布。在给 Mashable 的一份声明中，谷歌表示，它需要“更多一点的时间”来最终确定这些变化，官方声明可能会在“未来几周”发布