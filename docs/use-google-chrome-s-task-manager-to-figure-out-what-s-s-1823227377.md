...
真正令人惊讶的是看到你的扩展的内存占用。单独来看，一两个扩展可能不会占用你太多的可用内存，但如果你从开始使用谷歌浏览器以来一直在添加扩展，你可能会同时运行十几个或更多的扩展，不必要地消耗越来越多的内存。为了减少使用的内存量， [花点时间重新评估一下](https://lifehacker.com/it-s-time-for-you-to-clean-up-your-chrome-extensions-1819614337) 你已经安装的扩展数量和你实际使用它们的频率。提示:你肯定没有把它们都用上。