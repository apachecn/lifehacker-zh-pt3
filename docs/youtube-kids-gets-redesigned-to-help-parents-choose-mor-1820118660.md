...
[新的重新设计](https://youtube.googleblog.com/2017/11/introducing-kid-profiles-new-parental.html) 也在应用程序的设置过程中增加了一些功能，让父母更容易判断哪些内容适合他们的孩子。在设置过程中，你可以选择关闭儿童搜索功能，这将把可用视频的选择限制在主屏幕上显示的视频或应用程序推荐的视频。您可以设定密码来防止早熟的观众修改您已启用(或停用)的特定设置。

YouTube Kids 重申，你的孩子可能会偶然发现一个你可能认为不适合他们年龄的视频，所以你需要留意他们在看什么。然而，你可以选择阻止视频或频道在应用程序中重新出现。

其他功能的变化使孩子们更容易看到他们实际上可以理解的视频。年轻用户在界面上看到的文本会更少，而年长用户会看到更多帮助他们导航的文本，以及更多可供选择的内容。重新设计应该会在今天推出。