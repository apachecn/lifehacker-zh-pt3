...
嗯，我不会定制我目前的 PS4 控制器。那些要放在盒子里。我在 Sugru 给旧的 Xbox 360 控制器涂上涂层，确保它们能够经受住实际儿童的挑战。

硬化橡胶 Sugru 将保护您的控制器免受塑料破裂的影响。为了实现这一点，你需要弄清楚在你的控制器上实际上应该把这些东西放在哪里，包括它所有的曲线和边缘。

确定在哪里使用 Sugru 的一个快速方法是将控制器放在一个平面上，看看接触点在哪里。这些是第一批应该得到爱情的地方。在那里，你可以把 Sugru 塑造成你认为最好的任何形状。

在控制器接缝处的两侧放一些可以防止它突然打开或在塑料中产生裂缝，在操纵杆顶部添加一点也可以保护它们免受脏零食覆盖的手指的影响。这几分钟的准备会帮你省下一些坏掉的电子设备，并让吵闹的年轻人感到满意。