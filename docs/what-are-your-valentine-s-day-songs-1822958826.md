...
查看 Spotify 根据你的数据构建的完整曲目列表 ，并告诉我们缺少了什么。实际上， [我们做了一个合作的 Spotify 播放列表](https://open.spotify.com/user/toomuchnick/playlist/7rOWFB6wK8pV6R4niazzHg?si=-CcTr9xuTeqksqsZzpXEDA) 结合了所有的主题。继续添加你的歌曲。(只要跟着播放列表走，你就可以把任何一首歌拖到左栏的歌名上。)这将是一场爱情、性和心痛的情感过山车，所以请准备好在电脑前痛哭一场。