...
解决办法？在电脑上保存 AirPods 序列号的图片。您可以在包装盒上、盒盖的底部找到它，或者通过同步 AirPods 并前往手机上的“设置”>“通用”>“关于”>“AirPods”。

问题是，除非你有序列号，否则苹果不会更换外壳。该公司没有详细说明这是为什么，但一个流行的理论是，这是为了阻止 AirPod 小偷，他们需要一个新的外壳来装他们被盗的耳塞。

然而，有趣的是，苹果的确切政策似乎会根据具体情况而变化。一位 AirPods 的所有者 [说](https://www.reddit.com/r/apple/comments/82fkyv/lpt_take_a_screenshot_or_picture_of_your_airpods/dvbbgp4/) 该公司能够使用他们的苹果 ID 调出序列号，但该帖子上的大多数评论者说苹果根本没帮上什么忙。

如果您丢失了您的箱子，您也可以通过在另一个箱子中收费来找回序列号。试着从你的朋友那里借一台，或者在苹果商店使用一台演示设备。只是确保不要按下箱子上的按钮，否则你会丢失旧的序列号。

当然，你可以通过在电脑上存储序列号的图片来避免这一切。当你这样做的时候，你也可以创建一个文件夹来保存你所有的小工具序列号。以防万一。