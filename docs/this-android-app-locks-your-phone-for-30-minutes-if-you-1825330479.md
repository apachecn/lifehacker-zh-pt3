...
把我锁在外面也会变得很危险。您可以锁定您的手机，直到一天中的特定时间，设置它自动锁定一两个小时，或者创建一个每周锁定时间表。滚动到应用程序主页的底部，你甚至会发现一个选项，如果你每天的屏幕时间超过 5 小时，你可以锁定手机 30 分钟——或者你在一个小时内解锁手机超过 12 次。

这些技术可能看起来有点极端，但如果你真的无法阻止自己查看智能手机，在你最需要的时候，锁定我是一种简单的方法来强制短暂的技术休息。