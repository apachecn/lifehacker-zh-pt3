...
Freedom 仍然不能屏蔽 iOS 应用，只能屏蔽它们访问的互联网域。因此，你只能将 Twitter 这样的应用程序置于“离线模式”，而不能屏蔽令人上瘾的手机游戏等离线应用程序。这是一个巨大的限制。而且还是没有 Freedom 安卓应用；为此，你将需要，这是一个免费的自由许可证。

不过，屏蔽桌面应用是一大进步，尤其是如果你在家工作的话。我过去常常把下午浪费在玩迷你地铁上，而我本该写作的。应用屏蔽可以解决这个问题。

现在，自由与代码焦点打了 40%的折扣，将年度订阅降至 17.40 美元，将“永久”许可证降至仍然很高的 77.40 美元。(两种许可证都包括无限制下载到您的所有设备。)
